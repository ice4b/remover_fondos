# Cómo Remover Fondos de Imágenes con Python y Streamlit  Cómo Remover Fondos de Imágenes con Python y Streamlit
# https://www.youtube.com/watch?v=gGBfrLMkT0c
import os
...
def run_background_remover(input_img_file):
    ...
    output_img_path = input_img_path.replace('.', '_rembg.').replace('jpg', 'png').replace('jpeg', 'png')
    try:
